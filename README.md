...
All Axis devices have common EventInstances but some models might have (or not) particular EventInstances, for example Thermal cameras will have specific EventIntances that can be raised in relation with temperatures thresholds. 
